    ...
    <form method="post" action="http://localhost:8080/updateBlogAction.action" id="blog-post-edit"
        ...
        <fieldset>
            ...
            <div>
                ...
                <input type="text" value="<%=blog.getTag()%>" name="tag" id="blog_tags" class="elgg-input-tags"/>
            </div>
            <div>
            ...
            <div>
                ...
                <select name="access" id="blog_access_id"
                    ...
                    <option value="1" <%=blog.getAccess().equals("private") ? "selected=selected" : ""%>>Private
                    </option>
                    <option value="2" <%=blog.getAccess().equals("public") ? "selected=selected" : ""%>>Public
                    </option>
                    <option value="3" <%=blog.getAccess().equals("group") ? "selected=selected" : ""%>>Group</option>
                </select>
            </div>
            <div class="elgg-foot">
