...
<div id="container_1">
    ...
    <div id="mainContent_1">
        <div id="sidebar_1">
            <div id="left">
                <div id="bar1" align="center" class="STYLE1"><a href="http://localhost:8080/GetInternalNoticeAction!getAllResult.action">内部通知</a></div>
                <div id="bar2" align="center" class="STYLE1"><a href="http://localhost:8080/GetPublicNoticeAction!getAllResult.action">最新公告</a></div>
                <div id="bar3" align="center" class="STYLE1"><a href="#">图片新闻</a></div>
                <div id="bar4" align="center" class="STYLE1"><a href="http://localhost:8080/GetNewsAction!getAllResult.action">新闻快讯</a></div>
        ...
        <div  id="content_2">详细内容分条显示框
            <table width="578" height="423" border="0">
                ...
                <tr>
                    <td>
                        <a href="http://localhost:8080/GetNewsAction!getOneResult.action?newsid=<%=newses.get(i).getId()%>"><%= newses.get(i).getContent()%>
                        </a>
                    </td>
                </tr>
            <%}}%>
