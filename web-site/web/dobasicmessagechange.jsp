...
<SCRIPT language=javascript>
    ...
    window.location='basicmessagedesign.jsp';
        ...
        if(file_size<file_size_max){
            ...
            websiteMessage.setWebsitename(mySmartUpload.getRequest().getParameter("websitename"));
            System.out.println(mySmartUpload.getRequest().getParameter("websitename"));
            websiteMessage.setPath(saveurl);
            websiteMessage.setMaintenanceaddress(mySmartUpload.getRequest().getParameter("maintenanceaddress"));
            websiteMessage.setDefaultlanguage(mySmartUpload.getRequest().getParameter("defaultlanguage"));
            request.setAttribute("websitemess",websiteMessage);
//-----------------------上传完成，开始生成缩略图-------------------------
/*            java.io.File file = new java.io.File(saveurl);        //读入刚才上传的文件
            ...
            newimage.close(); */
                ...
                out.print("window.location='basicmessagedesign.jsp'");
                out.print("</SCRIPT>");
          }
      }
