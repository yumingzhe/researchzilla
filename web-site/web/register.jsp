...
<div id="container_1">
    ...
    <div id="mainContent_2">
        <form id="registerform" name="registerform" method="post" action="RegisterAction">
            <p align="center" class="STYLE3">请输入您的注册信息：</p>
            <table width="384" height="406" border="0" align="center">
                <tr>
                    <td width="134"><div align="center" class="STYLE3">用户名*</div></td>
                    <td width="240"><label>
                ...
                <tr>
                    <td><div align="center" class="STYLE3">重复密码*</div></td>
                    <td><label>
                        <input id="repassword" name="repassword" type="password" class="STYLE3" />
                    </label></td>
                </tr>
                <tr>
                    <td><div align="center" class="STYLE3">注册邮箱*</div></td>
                    <td><label>
                        <input id="email" name="email" type="text" class="STYLE3" />
                    </label></td>
                </tr>
                <tr>
                    <td><div align="center" class="STYLE3">用户ID号</div></td>
                    <td><label>
